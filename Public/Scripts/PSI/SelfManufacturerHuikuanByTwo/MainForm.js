...
Ext.define("PSI.SelfManufacturerHuikuanByTwo.MainForm", {
	extend: "Ext.panel.Panel",
	config: {
		pAddSelfManufacturerHuikuanByTwoBill: null,
		pEditSelfManufacturerHuikuanByTwoBill: null,
		pDeleteSelfManufacturerHuikuanByTwoBill: null,
		pImportSelfManufacturerHuikuanByTwoBill: null,
		pExportSelfManufacturerHuikuanByTwoBill: null,
		pVerifySelfManufacturerHuikuanByTwoBill: null,
		pRevertVerifySelfManufacturerHuikuanByTwoBill: null
	},
	//页面初始化
	...
	getToolbarCmp: function() {
		...
		return [{
			...
			scope: me,
			disabled: me.getPEditSelfManufacturerHuikuanByTwoBill() == "0",
			handler: me.onEditBill,
			id: "buttonEdit"
		}, "-", {
			text: "删除回款单",
			disabled: me.getPDeleteSelfManufacturerHuikuanByTwoBill() == "0",
			...
			text: "审核",
			disabled: me.getPVerifySelfManufacturerHuikuanByTwoBill() == "0",
			...
			scope: me,
			disabled: me.getPRevertVerifySelfManufacturerHuikuanByTwoBill() == "0",
			handler: me.onCommitReturn,
			id: "buttonRevertVerify"
		}, "-", {
			text: "导入自销回款单列表",
			disabled: me.getPImportSelfManufacturerHuikuanByTwoBill() == "0",
	...
	getUnEditedGrid: function() {
		...
		var modelName = "PSISelfManufacturerHuikuanByTwoBill";
		Ext.define(modelName, {
			extend: "Ext.data.Model",
			fields: ["id", "drug_id", 'common_name', 'goods_name', 'jx', 'guige', 'manufacturer',
				'bill_code', "deliver_huikuan_bill_id",
				"deliver_id", 'deliver_name', "kaipiao_unit_price", 'huikuan_amount','huikuan_way','huikuan_money',
		...
		var store = Ext.create("Ext.data.Store", {
			...
			proxy: {
				...
				url: PSI.Const.BASE_URL + "Home/SelfManufacturerHuikuanByTwo/listSelfManufacturerHuikuanByTwoUnEdit",
				reader: {
		...
		me.unEditedGrid = Ext.create("Ext.grid.Panel", {
			...
			tbar: [{
				...
				text: "导出未编辑回款单信息",
				disabled: me.getPExportSelfManufacturerHuikuanByTwoBill() == "0",
	...
	getEditedGrid: function() {
		...
		Ext.define(modelName, {
			...
			fields: ["id", "drug_id", 'common_name', 'goods_name', 'jx', 'guige', 'manufacturer',
				...
				'huikuan_num', 'huikuan_money','huikuan_way','sum_kaipiao_money', 'huikuan_account', 'huikuan_account_name',
		...
		var store = Ext.create("Ext.data.Store", {
			...
			proxy: {
				...
				url: PSI.Const.BASE_URL + "Home/SelfManufacturerHuikuanByTwo/listSelfManufacturerHuikuanByTwoEdit",
				reader: {
					root: 'selfHuikuanList',
					totalProperty: 'totalCount'
				}
	...
	onEditBill: function() {
		...
		if (!isParent) {
			//异步获取总量和剩余入库量
			Ext.Ajax.request({
				url: PSI.Const.BASE_URL + "Home/SelfManufacturerHuikuanByTwo/getHuikuanAmount",
				method: 'POST',
				params: {
					id: bill.get('id')
				},
				success: function(response) {
					...
					var form = Ext.create("PSI.SelfManufacturerHuikuanByTwo.SelfManufacturerHuikuanByTwoEditForm", {
						parentForm: me,
						entity: bill
					});
					form.show();
	...
	onDeleteBill: function() {
		...
		PSI.MsgBox.confirm(info, function() {
			...
			el.mask("正在删除中...");
			Ext.Ajax.request({
				url: PSI.Const.BASE_URL + "Home/SelfManufacturerHuikuanByTwo/deleteSelfManufacturerHuikuanByTwo",
				method: "POST",
				params: {
					id: bill.get("id"),
	...
	verifyRequest: function(bill, type) {
		...
		el.mask("正在提交中...");
		Ext.Ajax.request({
			url: PSI.Const.BASE_URL + "Home/SelfManufacturerHuikuanByTwo/selfHuikuanStatus",
			method: "POST",
			params: {
				id: id,
				type: type
