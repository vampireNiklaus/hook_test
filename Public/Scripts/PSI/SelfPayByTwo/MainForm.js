...
Ext.define("PSI.SelfPayByTwo.MainForm", {
	extend: "Ext.panel.Panel",
	config: {
		pEditSelfPayByTwoBill: null,
		pDeleteSelfPayByTwoBill: null,
		pImportSelfPayByTwoBill: null,
		pExportSelfPayByTwoBill: null,
		pVerifySelfPayByTwoBill: null,
		pRevertVerifySelfPayByTwoBill: null
	},
	//页面初始化
	initComponent: function() {
		...
		Ext.apply(me, {
			...
			tbar: [{
				...
				disabled: me.getPEditSelfPayByTwoBill() == "0",
				id: "buttonEdit"
			}, "-", {
				text: "删除付款单",
				iconCls: "PSI-button-delete",
				disabled: me.getPDeleteSelfPayByTwoBill() == "0",
				scope: me,
				handler: me.onDeleteBill,
				id: "buttonDelete"
			}, "-", {
				text: "审核",
				// disabled : me.getPVerifySelfPayByTwoBill() == "0",
				...
				text: "反审核",
				// disabled : me.getPRevertVerifySelfPayByTwoBill() == "0",
				...
				text: "导入自销付款单列表",
				disabled: me.getPImportSelfPayByTwoBill() == "0",
	...
	getUnEditedGrid: function() {
		...
		var modelName = "PSISelfPayByTwoBill";
		Ext.define(modelName, {
			extend: "Ext.data.Model",
			fields: ["id", "drug_id", 'common_name', 'goods_name', 'jx', 'guige', 'manufacturer',
				'bill_code', "buy_bill_id", 'kaidan_ren',
				 "base_price", 'kaipiao_unit_price', 'sum_kaipiao_money',
				"sum_pay_money", "pay_amount", "buy_date", 'buy_bill_code',
				"yewu_date", 'tax_unit_price', 'sum_tax_money', 'status', 'status_str', 'operate_info','huikuan_way'
			]
		});
		var store = Ext.create("Ext.data.Store", {
			...
			proxy: {
				...
				url: PSI.Const.BASE_URL + "Home/SelfPayByTwo/listSelfPayByTwoUnEdit",
				reader: {
					root: 'selfPayList',
		...
		me.unEditedGrid = Ext.create("Ext.grid.Panel", {
			...
			tbar: [{
				...
				text: "导出未编辑付款单信息",
				disabled: me.getPExportSelfPayByTwoBill() == "0",
				...
				listeners: {
					...
					beforeshow: function updateTipBody(tip) {
						...
						tip.update(
							...
							"<span style='margin-right: 20px'>买货底价：<b style='color:red'>" + re.get('base_price') +"</b></br>" +
	...
	getEditedGrid: function() {
		...
		Ext.define(modelName, {
			...
			fields: ["id", "drug_id", 'common_name', 'goods_name', 'jx', 'guige', 'bill_code',
				...
				'pay_1st_account_name', 'pay_1st_account_num', 'pay_2nd_account_name', 'pay_2nd_account_num', 'operate_info','huikuan_way'
			]
		});
		var store = Ext.create("Ext.data.Store", {
			autoLoad: false,
			...
			proxy: {
				...
				url: PSI.Const.BASE_URL + "Home/SelfPayByTwo/listSelfPayByTwoEdit",
				reader: {
					root: 'selfPayList',
					totalProperty: 'totalCount'
				}
	...
	onEditBill: function() {
		...
		var form = Ext.create("PSI.SelfPayByTwo.SelfPayByTwoEditForm", {
			parentForm: me,
			entity: bill
		});
		form.show();
	...
	onDeleteBill: function() {
		...
		PSI.MsgBox.confirm(info, function() {
			...
			el.mask("正在删除中...");
			Ext.Ajax.request({
				url: PSI.Const.BASE_URL + "Home/SelfPayByTwo/deleteSelfPayByTwo",
				method: "POST",
				params: {
					id: bill.get("id")
				},
	...
	verifyRequest: function(bill, type) {
		...
		el.mask("正在提交中...");
		Ext.Ajax.request({
			url: PSI.Const.BASE_URL + "Home/SelfPayByTwo/selfPayStatus",
			method: "POST",
			params: {
				id: id,
				type: type
