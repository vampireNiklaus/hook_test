 ...
 * 供应商自定义字段
 */
Ext.define("PSI.BankDeposit.BankAccountField", {
	extend: "Ext.form.field.Trigger",
	alias: "widget.psi_bank_account_field",
	...
	onTriggerClick: function(e) {
		...
		Ext.define(modelName, {
			...
			fields: ["id", "account_name", "account_num"]
		});
		...
		var editName = Ext.getCmp("__editAccountName");
		editName.on("change", function() {
			var store = me.lookupGrid.getStore();
			Ext.Ajax.request({
				url: PSI.Const.BASE_URL + "Home/BankDeposit/queryData",
				params: {
