 ...
 * 自销入库单 - 编辑界面
 */
Ext.define("PSI.SelfStock.SelfStockEditForm", {
				...
				items : [{
					...
					items: [

						{
							...
							checked : entity === null ? true : entity.get("is_broken") == 1
						}, {
							boxLabel  : '否',
							name      : 'is_broken',
							inputValue: '0',
							id        : 'is_broken_radio_no',
							checked : entity === null ? false : entity.get("is_broken") == 0,
						}
					],
					value : entity == null ? null : entity.get("is_broken"),
					listeners : {
						change : {
							fn : me.onIsBrokenKey,
							scope : me
	...
	onOK : function(thenAdd) {
		...
		f.submit({
			url : PSI.Const.BASE_URL + "Home/SelfStock/editSelfStock",
			method : "POST",
