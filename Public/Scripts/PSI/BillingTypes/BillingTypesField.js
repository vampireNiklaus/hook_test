 ...
 * 供应商自定义字段
 */
Ext.define("PSI.BillingTypes.BillingTypesField", {
	extend: "Ext.form.field.Trigger",
	alias: "widget.psi_billing_types_field",
	...
	onTriggerClick: function(e) {
		...
		var editName = Ext.getCmp("__editTypes");
		editName.on("change", function() {
			var store = me.lookupGrid.getStore();
			Ext.Ajax.request({
				url: PSI.Const.BASE_URL + "Home/BillingTypes/queryData",
				params: {
