...
Ext.define("PSI.SelfStockByTwo.MainForm", {
	...
	getUnEditedGrid: function() {
		...
		var modelName = "PSISelfStockByTwoBill";
		Ext.define(modelName, {
			extend: "Ext.data.Model",
			fields: ["id", "drug_id", 'common_name', 'goods_name', 'jx', 'guige', 'manufacturer', 'jldw',
				'bill_code', "pay_bill_id", 'pay_bill_code',  'validity', "huikuan_way","is_broken","buy_date",
				"stock_amount", "need_amount", "kaipiao_unit_price", 'status_str', 'status', 'operate_info', 'buy_date', 'batch_num'
			]
		});
		var store = Ext.create("Ext.data.Store", {
			...
			proxy: {
				...
				url: PSI.Const.BASE_URL + "Home/SelfStockByTwo/listSelfStockByTwoUnEdit",
				reader: {
					root: 'selfStockList',
	...
	getEditedGrid: function() {
		...
		Ext.define(modelName, {
			extend: "Ext.data.Model",
			fields: ["id", "drug_id", 'common_name', 'goods_name', 'jx', 'guige', 'manufacturer', 'jldw',
				'bill_code', "deliver_id", 'deliver_name', "stock_num","huikuan_way","is_broken","buy_date","tax_shuipiao_code",
		...
		var store = Ext.create("Ext.data.Store", {
			...
			proxy: {
				...
				url: PSI.Const.BASE_URL + "Home/SelfStockByTwo/listSelfStockByTwoEdit",
				reader: {
					root: 'selfStockList',
					totalProperty: 'totalCount'
				}
	...
	onEditBill: function() {
		...
		if (!flag) {
			//异步获取总量和剩余入库量
			Ext.Ajax.request({
				url: PSI.Const.BASE_URL + "Home/SelfStockByTwo/getStockAmount",
				method: 'POST',
				params: {
					id: bill.get('id')
				},
				success: function(response) {
					...
					var form = Ext.create("PSI.SelfStockByTwo.SelfStockByTwoEditForm", {
						parentForm: me,
						entity: bill
					});
					form.show();
	...
	onDeleteBill: function() {
		...
		PSI.MsgBox.confirm(info, function() {
			...
			el.mask("正在删除中...");
			Ext.Ajax.request({
				url: PSI.Const.BASE_URL + "Home/SelfStockByTwo/deleteSelfStockByTwo",
				method: "POST",
				params: {
					id: bill.get("id"),
	...
	verifyRequest: function(bill, type) {
		...
		el.mask("正在提交中...");
		Ext.Ajax.request({
			url: PSI.Const.BASE_URL + "Home/SelfStockByTwo/selfStockStatus",
			method: "POST",
			params: {
				id: id,
				type: type
