 ...
 * 供应商自定义字段
 */
Ext.define("PSI.Employee.EmployeeField", {
	extend: "Ext.form.field.Trigger",
	alias: "widget.psi_employeefield",
	...
	onTriggerClick: function(e) {
		var me = this;
		var modelName = "PSIEmployeeField";
		...
		var editName = Ext.getCmp("__editEmployee");
		editName.on("change", function() {
			var store = me.lookupGrid.getStore();
			Ext.Ajax.request({
				url: PSI.Const.BASE_URL + "Home/Employee/queryData",
				params: {
