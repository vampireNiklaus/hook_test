 ...
 * @author Baoyu Li
 */
Ext.define("PSI.Employee.EmployeeImportForm", {
		...
		Ext.apply(me, {
			...
			items : [{
				...
				items : [{
					...
					html : "<a href=../Uploads/Employee/dailySellModelFile.xls ><h4>业务员信息导入模板下载</h4></a>",
					border : 0
				}
				],
				buttons : buttons
	...
	onUploadExcel : function() {
		...
		el.mask('正在导入...');
		f.submit({
					url : PSI.Const.BASE_URL + "Home/Employee/import",
					method : "POST",
