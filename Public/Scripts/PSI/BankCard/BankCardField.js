 ...
 * 账户自定义字段
 */
Ext.define("PSI.BankCard.BankCardField", {
	...
	onTriggerClick: function(e) {
		var me = this;
		var modelName = "PSIBankCardField";
		...
		var editName = Ext.getCmp("__editBankCard");
		editName.on("change", function() {
			var store = me.lookupGrid.getStore();
			Ext.Ajax.request({
				url: PSI.Const.BASE_URL + "Home/BankCard/queryData",
				params: {
