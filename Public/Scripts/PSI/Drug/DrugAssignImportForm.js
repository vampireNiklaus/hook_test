 ...
 * @author Baoyu Li
 */
Ext.define("PSI.Drug.DrugAssignImportForm", {
		...
		Ext.apply(me, {
			...
			items : [{
				...
				items : [{
					...
					allowBlank : false,
					anchor : '100%',
					buttonText : '选择药品-医院分配信息文件'
				}, {
					html : "<a href=../Uploads/Drug/dailySellModelFile.xls ><h4>药品-医院分配信息导入模板下载</h4></a>",
					border : 0
				}
				//,{
	...
	onUploadExcel : function() {
		...
		el.mask('正在导入...');
		f.submit({
					url : PSI.Const.BASE_URL + "Home/Drug/importDrugAssign",
					method : "POST",
