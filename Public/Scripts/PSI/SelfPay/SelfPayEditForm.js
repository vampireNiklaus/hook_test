 ...
 * 自销付款单 - 编辑界面
 */
Ext.define("PSI.SelfPay.SelfPayEditForm", {
		...
		Ext.apply(me, {
			...
			items : [{
				...
				items : [{
					...
					colspan : 2,
					width:200,
					value :'<b style="color:red;">'+ entity.get("unit_price")+'</b>',
				}, {
					fieldLabel : "买货金额",
					xtype:'displayfield',
					colspan : 4,
				...
				// 	colspan : 2,
				// 	width:200,
				// 	value :'<b style="color:red;">'+entity.get("kaipiao_unit_price")+'</b>',
				// }, {
				// 	xtype:'displayfield',
				// 	fieldLabel : "开票金额",
				// 	colspan : 4,
				// 	value :'<b style="color:red;">'+entity.get("sum_kaipiao_money")+'</b>',
				// },{
				// 	xtype:'displayfield',
				// 	fieldLabel : "税价",
				// 	colspan : 2,
				// 	width:200,
				// 	value :'<b style="color:red;">'+entity.get("tax_unit_price")+'</b>',
				// }, {
				// 	fieldLabel : "税额",
				// 	xtype:'displayfield',
				// 	colspan : 4,
				// 	value :'<b style="color:red;">'+ entity.get("sum_tax_money")+'</b>',
				// },
					{
					fieldLabel : "采购日期",
					colspan : 2,
	...
	onOK : function(thenAdd) {
		...
		f.submit({
			url : PSI.Const.BASE_URL + "Home/SelfPay/editSelfPay",
			method : "POST",
